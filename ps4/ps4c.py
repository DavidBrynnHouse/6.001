...
class SubMessage(object):
    ...
    def build_transpose_dict(self, vowels_permutation):
        ...
        for a in string.ascii_letters:
            if a.lower() in VOWELS_LOWER:
                transpose_dict[a] = vowels_permutation[0]
                vowels_permutation = vowels_permutation[1:]
            else:
                transpose_dict[a] = a
    ...
    def apply_transpose(self, transpose_dict):
        ...
        """
        encrypted_message = ""
        for a in str(self.get_message_text()):
            try:
                encrypted_message += transpose_dict[a]
            except KeyError:
                encrypted_message += a
...
class EncryptedSubMessage(SubMessage):
    ...
    def decrypt_message(self):
        ...
        for a in perm_vowels:
            ...
            transformed = self.get_message_text().apply_transpose(transpose_dict)
...
if __name__ == '__main__':
    ...
    message = SubMessage("a large owl ate an egg")
    td = message.build_transpose_dict("iaoue")
    print(message.apply_transpose(td))
    sub_message = EncryptedSubMessage(message)
    print(sub_message.decrypt_message())
